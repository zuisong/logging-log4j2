...
Fully qualified class name of a custom `org.apache.logging.log4j.jul.spi.AbstractLoggerAdapter` implementation to use, which provides an implementation of the `j.u.l.Logger` mutator methods (e.g., `Logger.setLevel()`).
