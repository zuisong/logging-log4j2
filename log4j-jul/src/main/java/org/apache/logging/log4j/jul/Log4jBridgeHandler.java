 ...
 * <p>
 *     This is an alternative to {@link LogManager} (running as complete JUL replacement), especially useful for
 *     webapps running on a container for which the LogManager cannot or should not be used.
 * </p>
 *
 * <p>
 *     Installation/usage:
    ...
    private void configure(String suffixToAppend, boolean propagateLevels) {
        ...
        if (installAsLevelPropagator) {
            ...
            if (levelPropagator == null) {
                LOGGER.warn(
                        "A JUL level propagator was requested, but no implementation was found.\nSee {} for details.",
                        DOC_URL);
